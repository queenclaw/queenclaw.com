    ...
    return (
      <button
        className={cn(
          ...
          {
            "bg-white text-black shadow hover:bg-white/90": variant === "default",
            "bg-red-500 text-white shadow-sm hover:bg-red-500/90": variant === "destructive",
            "border border-white/20 bg-transparent shadow-sm hover:bg-white/5 hover:text-white": variant === "outline",
