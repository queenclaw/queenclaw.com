...
export function usePWA() {
  ...
  return { canInstall, isInstalled, isOffline, install };
}
...
export function PWABadge() {
  ...
  if (canInstall) {
    return (
      <button
        onClick={install}
        className="inline-flex items-center gap-1 px-2 py-1 bg-purple-500/10 text-purple-400 text-xs rounded-full hover:bg-purple-500/20 transition-colors"
      >
        <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
